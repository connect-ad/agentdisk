...
| 031 | [Upstream the modal scroll contract](backlog/031-upstream-modal-scroll-contract.md) | Open — fourth vendored divergence; `Modal.jsx` gains Enter-to-submit |
